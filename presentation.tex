...
\textcolor{red}{xref: FBbt:00003154}
      \end{block}
  ...
  \begin{overlayarea}{\textwidth}{3cm}
    ...
    \only<5-10>{
      \begin{block}{Generating a more complex axiom}\ttfamily\scriptsize
        ...
        \hspace{1cm} \&\& (\textcolor<7>{red}{mapping\_justification==semapv:ManualMappingCuration} \textcolor<8>{red}{||} \textcolor<9>{red}{confidence>=0.8)}\\
...
\begin{frame}
  ...
  \begin{block}{\includegraphics[scale=.26]{ccbysa}\hspace{.2em}2024 Damien Goutte-Gattat}
    This work is licensed under the Creative Commons Attributions-ShareAlike
    4.0 License.
  \end{block}

  \begin{block}{Contact}
    \href{mailto:dpg44@cam.ac.uk}{\texttt{dpg44@cam.ac.uk}}
  \end{block}
\end{frame}
